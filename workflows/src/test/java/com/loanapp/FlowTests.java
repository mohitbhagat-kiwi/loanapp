...
import com.loanapp.flows.TemplateFlow;
import com.loanapp.states.TemplateState;
...
public class FlowTests {
    ...
    public void setup() {
        network = new MockNetwork(new MockNetworkParameters().withCordappsForAllNodes(ImmutableList.of(
                TestCordapp.findCordapp("com.loanapp.contracts"),
                TestCordapp.findCordapp("com.loanapp.flows")))
